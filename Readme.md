...
I finally could run the app using the following tutorial.

```https://www.youtube.com/watch?v=BqI1hu0gIb0```

I had still one problem. I couldn't have the AppSettings.json in my GIT commit. So I had to comment all of the lines that included _configuration. I had to change variables from Jwt:Issuer for example to JwtIssuer. Finally all of the variables that were in the configuration file was replaced by Env Variables and appsettings.json was deleted.